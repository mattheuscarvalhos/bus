...
if($linhas > 0){
	...
	$sobrenome_usuario = $res[0]['sobrenome'];
...
<html>
<head>
	<title>Aemarbus - Painel Administrativo</title>
			...
			<aside class="sidebar-left" style="overflow: scroll; height:100%; scrollbar-width: thin;">
				<nav class="navbar navbar-inverse">
					<div class="navbar-header">
						...
						<h1><a class="navbar-brand" href="index.php"><i class="fa-solid fa-bus"></i></span> Aemarbus<span class="dashboard_text">Painel Administrativo</span></a></h1>
					</div>
						...
						<ul class="sidebar-menu">
							...
							<li class="treeview">
								...
								<ul class="treeview-menu">
									<li><a href="index.php?pagina=usuarios"><i class="fa fa-angle-right"></i> Associados</a></li>
					...
					<ul>
						<li class="dropdown profile_details_drop">
							...
							<ul class="dropdown-menu drp-mnu">
								...
								<li> <a href="../login/logout.php"><i class="fa fa-sign-out"></i> Sair</a> </li>
							</ul>
						</li>
					</ul>
				</div>
...
<!-- Modal Perfil -->
<div class="modal fade" id="modalPerfil" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-bs-backdrop="static">
			...
			<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-6">							
								...
								<input type="text" class="form-control" id="nome_perfil" name="sobrenome" placeholder="Seu Sobrenome" value="<?php echo $sobrenome_usuario ?>" required>							
						</div>
					</div>
